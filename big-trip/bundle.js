...
class Component {
  ...
  unrender() {//  TODO написать unrender
  }
...
/* harmony import */ var _mock_trip_points_data__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../mock/trip-points-data */ "./src/mock/trip-points-data.js");
/* harmony import */ var _trip_point__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./trip-point */ "./src/components/trip-point.js");
...
class Filter extends _component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  ...
  _onChange(ev) {
    ...
    if (ev.target.value === `everything`) {
      filteredData = _mock_trip_points_data__WEBPACK_IMPORTED_MODULE_2__["default"];
    } else {
      filteredData = _utils__WEBPACK_IMPORTED_MODULE_1__["default"].getRandomElementsFromArray(_mock_trip_points_data__WEBPACK_IMPORTED_MODULE_2__["default"], _utils__WEBPACK_IMPORTED_MODULE_1__["default"].getRandomInt(4));
    }

    _utils__WEBPACK_IMPORTED_MODULE_1__["default"].renderComponent(document.querySelector(`.trip-day__items`), filteredData, _trip_point__WEBPACK_IMPORTED_MODULE_3__["default"], `tripPoints`);
  }

  bind() {
    document.querySelector(`.trip-filter`).addEventListener(`change`, this._onChange);
  }
...
/***/ "./src/components/trip-point-edit-destinations.js":
/*!********************************************************!*\
  !*** ./src/components/trip-point-edit-destinations.js ***!
  \********************************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = (tripPointEditDestinations);

/***/ }),

/***/ "./src/components/trip-point-edit.js":
/*!*******************************************!*\
  !*** ./src/components/trip-point-edit.js ***!
  \*******************************************/
/*! exports provided: default */
...
/* harmony import */ var _trip_point_edit_destinations__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./trip-point-edit-destinations */ "./src/components/trip-point-edit-destinations.js");
...
class TripPointEdit extends _component__WEBPACK_IMPORTED_MODULE_1__["default"] {
  /**
  ...
  constructor(data, options = {}) {
    ...
    this._props = {
      ...
      cities: [`Baghdad`, `Bahia Blanca`, `Baku`, `Bandung`, `Bangalore`, `Bangkok`, `Banjul`, `Barcelona`]
    };
    this._state = {
      icon: data.icon,
          ...
          <header class="point__header">
            <label class="point__date" style="display: block">
              ...
              <input 
                ...
                placeholder="MAR 18"
                name="day"
                value="${this._state.date ? moment__WEBPACK_IMPORTED_MODULE_3___default()(this._state.date).format(`MMM D`) : ``}"
              >
            </label>
            ...
            <div class="point__destination-wrap">
              ...
              <datalist id="destination-select">
                ${Object(_trip_point_edit_destinations__WEBPACK_IMPORTED_MODULE_2__["default"])(this._props.cities)}
              </datalist>
            </div>
            ...
            <label class="point__time">
              ...
              <input 
                ...
                value="${this._state.time ? moment__WEBPACK_IMPORTED_MODULE_3___default()(this._state.time).format(`H mm`) : ``}"
                name="time" 
              >
            </label>
  ...
  bind() {
    if (this.onSave) {
      this._element.querySelector(`.point__form`).addEventListener(`submit`, ev => this.onSave(ev, this));
    }
    ...
    this._element.querySelector(`.travel-way__select`).addEventListener(`change`, this._onTripTypeChange);

    this._element.querySelector(`.point__destination-input`).addEventListener(`change`, this._onDestinationChange);

    this._element.querySelector(`.point__date .point__input`).addEventListener(`input`, this._onDateChange);

    this._element.querySelector(`.point__time .point__input`).addEventListener(`input`, this._onTimeChange);

    this.calendar = flatpickr__WEBPACK_IMPORTED_MODULE_0___default()(this._element.querySelector(`.point__date .point__input`), {
      dateFormat: `M j`
    });
    this.timePicker = flatpickr__WEBPACK_IMPORTED_MODULE_0___default()(this._element.querySelector(`.point__time .point__input`), {
      enableTime: true,
      noCalendar: true,
      dateFormat: `H:i`
    });

    this._element.querySelector(`.point__price .point__input`).addEventListener(`input`, this._onPriceChange);
...
/* harmony default export */ __webpack_exports__["default"] = (TripPointEdit);

/***/ }),

/***/ "./src/components/trip-point-offers.js":
/*!*********************************************!*\
  !*** ./src/components/trip-point-offers.js ***!
  \*********************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = (tripPointOffers);

/***/ }),

/***/ "./src/components/trip-point.js":
/*!**************************************!*\
  !*** ./src/components/trip-point.js ***!
  \**************************************/
/*! exports provided: default */
...
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _component__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./component */ "./src/components/component.js");
/* harmony import */ var _trip_point_offers__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./trip-point-offers */ "./src/components/trip-point-offers.js");



class TripPoint extends _component__WEBPACK_IMPORTED_MODULE_0__["default"] {
  /**
   * @param {Object} data - input data for component
    ...
    return `
      <article class="trip-point">
        ...
        <ul class="trip-point__offers">
          ${Object(_trip_point_offers__WEBPACK_IMPORTED_MODULE_1__["default"])(this._state.offers)}
        </ul>
      </article>
    `.trim();
  }
...
/* harmony default export */ __webpack_exports__["default"] = (TripPoint);

/***/ }),

/***/ "./src/currently-rendered-objects.js":
/*!*******************************************!*\
  !*** ./src/currently-rendered-objects.js ***!
  \*******************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = (currentlyRenderedObjects);
...
/* harmony import */ var _components_trip_point__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./components/trip-point */ "./src/components/trip-point.js");
/* harmony import */ var _mock_trip_points_data__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./mock/trip-points-data */ "./src/mock/trip-points-data.js");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./utils */ "./src/utils.js");
/* harmony import */ var _mock_filters_data__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./mock/filters-data */ "./src/mock/filters-data.js");
/* harmony import */ var _components_trip_point_edit__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./components/trip-point-edit */ "./src/components/trip-point-edit.js");
...
_utils__WEBPACK_IMPORTED_MODULE_3__["default"].defineCurrentlyRenderedObjects(_mock_filters_data__WEBPACK_IMPORTED_MODULE_4__["default"], _components_filter__WEBPACK_IMPORTED_MODULE_0__["default"], {}, `filters`);
_utils__WEBPACK_IMPORTED_MODULE_3__["default"].renderComponent(document.querySelector(`.trip-filter`), `filters`);
...
const tripPointOptions = () => {
  return {
    onEdit(ev) {
      ...
      this.unbind();
      const tripPointEditElement = new _components_trip_point_edit__WEBPACK_IMPORTED_MODULE_5__["default"](newElementState, tripPointEditOptions(this)).render();
...
_utils__WEBPACK_IMPORTED_MODULE_3__["default"].defineCurrentlyRenderedObjects(_mock_trip_points_data__WEBPACK_IMPORTED_MODULE_2__["default"], _components_trip_point__WEBPACK_IMPORTED_MODULE_1__["default"], tripPointOptions(), `tripPoints`);
_utils__WEBPACK_IMPORTED_MODULE_3__["default"].renderComponent(document.querySelector(`.trip-day__items`), `tripPoints`);

/***/ }),

/***/ "./src/mock/filters-data.js":
/*!**********************************!*\
  !*** ./src/mock/filters-data.js ***!
  \**********************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = (FILTERS_DATA);

/***/ }),

/***/ "./src/mock/trip-points-data.js":
/*!**************************************!*\
  !*** ./src/mock/trip-points-data.js ***!
  \**************************************/
/*! exports provided: default */
...
const DATA = {
  ...
  cities: [`Baghdad`, `Bahia Blanca`, `Baku`, `Bandung`, `Bangalore`, `Bangkok`, `Banjul`, `Barcelona`],
  offers: new Set([`Add luggage`, `Switch to comfort class`, `Add meal`, `Choose seats`]),
...
function generateTripPoint() {
  return {
    tripType: _utils__WEBPACK_IMPORTED_MODULE_0__["default"].getRandomKeyFromObject(DATA.tripTypes),
    city: DATA.cities[DATA.cities.length * Math.random() << 0],
    timetable: `22:00&nbsp;&mdash; 07:00`,
    duration: `2h 40m`,
    price: `20`,
    offers: _utils__WEBPACK_IMPORTED_MODULE_0__["default"].getRandomElementsFromArray([...DATA.offers], _utils__WEBPACK_IMPORTED_MODULE_0__["default"].getRandomInt(2)),
...
/* harmony default export */ __webpack_exports__["default"] = (TRIP_POINTS_DATA);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _currently_rendered_objects__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./currently-rendered-objects */ "./src/currently-rendered-objects.js");
...
const utils = {
  ...
  defineCurrentlyRenderedObjects(data, Component, options, componentsName) {
    Object.defineProperty(_currently_rendered_objects__WEBPACK_IMPORTED_MODULE_0__["default"], componentsName, {
      value: [],
      writable: true,
      configurable: true
    });
    data.forEach(el => {
      _currently_rendered_objects__WEBPACK_IMPORTED_MODULE_0__["default"][componentsName].push(new Component(el, options));
    });
  },
  ...
  renderComponent(container, componentsName) {
    container.innerHTML = ``;
    utils.renderElements(container, _currently_rendered_objects__WEBPACK_IMPORTED_MODULE_0__["default"][componentsName].map(el => {
      return el.render();
    }));
  }
